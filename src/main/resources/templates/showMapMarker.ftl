...
<div class="input-card">
    ...
    <div class="input-item">
        <input id="addMarker" type="button" class="btn" onclick="addMarker()" value="显示位置">
        <input id="updateMarker" type="button" class="btn" onclick="updateIcon()" value="更新位置">
    </div>
    <div class="input-item">
...
<script type="text/javascript"
        src="https://webapi.amap.com/maps?v=1.4.15&key=${key}"></script>
<script type="text/javascript">
